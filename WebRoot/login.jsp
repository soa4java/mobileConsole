										...
										<td>
											...
											<table width="100%" border="0" align="center" cellpadding="0" cellspacing="5">
												<tr>
													...
													<td><input type="text" name="j_username" validate="{required:true}" style="width: 150px;" maxlength="30" value=""/></td>
												</tr>
												<tr>
													<td height="40" align="right"><strong>密码</strong></td>
													<td><input type="password" name="j_password"  validate="{required:true}" style="width: 150px;" maxlength="30" value=""/></td>
												</tr>	
												<tr>
												...
												<c:if test="${param.error eq 2 }">
													<tr>
														<td></td>
														<td class="red">验证码无效</td>
													</tr>
												</c:if>														
												<c:if test="${param.error eq null && error ne null }">
													<tr>
														<td></td>

...
<div class="box">
	...
	<script type="text/javascript">
		...
		<c:forEach items="${list}" var="e">d.add('${e.id}','${e.pid}','${e.name}','${ctx }/authority/viewAuthority?eid=${e.id}');
		</c:forEach>		
		document.write(d);
...
<style>
.box{margin: 5px 0 0 5px;padding: 5px 0 0 5px;border:1px solid #B4CFCF;background:#F9FBFD;position: absolute;height: 96%;width: 92%;}
</style>

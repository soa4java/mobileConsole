...
<%@ include file="/page/head.html" %>
	<div class="body-box">
		...
		<form method="post"  id="form" enctype="multipart/form-data" action="${ctx }/web-resource/save">
			<input type="hidden" name="id" value="${id }"/>
 			<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0">
				<s:token/>
					...
					<tr>						
						<td width="12%" class="pn-flabel"><span class="pn-frequired">*</span>资源文件</td>
						<td  width="38%" class="pn-fcontent">
							<input type="file" name="resFile" validate="{required:${id eq null?'true':'false' },accept:'zip',messages:{required:'请上传apk文件',accept:'请上传zip文件'}}"/>
						</td>

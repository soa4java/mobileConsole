...
public class VUserRoleDao extends HibernateDao<VUserRole, Long> {
	...
	public void delete(Long roleId, Long userId) {
		String hql = "delete from TBL_USER_ROLE where role_id=:roleId and user_id=:userId";
	...
	public int delete(Long roleId, Long[] userIds) {
		...
		StringBuilder builder = new StringBuilder("delete from TBL_USER_ROLE where role_id=");

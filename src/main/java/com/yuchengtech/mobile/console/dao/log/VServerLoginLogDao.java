 ...
 */
@Repository
public class VServerLoginLogDao extends HibernateDao<VServerLoginLog, Long> {
	
	public Long countByProperty(String propertyName, Object value) {
		String hql = "from VServerLoginLog where "+propertyName+"=?";
	...
	public int batchDelete(Long[] ids) {
		...
		hql.append("delete from VServerLoginLog entity where entity.id in");
